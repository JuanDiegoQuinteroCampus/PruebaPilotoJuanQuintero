...
{
    private $queryPost = 'INSERT INTO soft_skills(id,id_team_schedule,id_journey,id_trainer,id_location,id_subject) VALUES(:num,:idteamsche,:idjourney,:idtrainer,:idlocation,:idsubject)';
    private $queryGetAll = 'SELECT * FROM soft_skills';
    private $queryUpdate = 'UPDATE soft_skills SET id = :num, id_team_schedule = :idteamsche, id_journey = :idjourney, id_trainer = :idtrainer, id_location = :idlocation, id_subject = :idsubject  WHERE id = :num';
    private $queryDelete = 'DELETE FROM soft_skills WHERE id = :num';
    private $message;
    use getInstance;
    ...
    public function putSoft_skills()
    {
        try {
