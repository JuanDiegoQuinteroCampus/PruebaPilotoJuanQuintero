...
{
    private $queryPost = 'INSERT INTO maint_area(id,id_area,id_staff,id_position,id_journey) VALUES(:num,:idarea,:idstaf,:idposition,:idjourney)';
    private $queryGetAll = 'SELECT * FROM maint_area';
    private $queryUpdate = 'UPDATE maint_area SET id = :num, id_area = :idarea, id_staff = :idstaf, id_position = :idposition, id_journey = :idjourney  WHERE id = :num';
    private $queryDelete = 'DELETE FROM maint_area WHERE id = :num';
    private $message;
    use getInstance;
